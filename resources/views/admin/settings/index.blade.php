            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.settings.index') }}" class="text-muted text-hover-primary">الاعدادات
                                المضافة</a>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.settings.create') }}" class="btn btn-sm fw-bold btn-primary">اعدادات </a>
                    {{-- <a href="{{ route('admin.setting.trash') }}" class="btn btn-sm fw-bold btn-danger">سلة المهملات</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($settings as $setting)
                                            <tr>
                                                ...
                                                <td>{{$setting->id}}</td>
                                                <td><img src="{{ url('setting_logos/'.$setting->logo) }}" style="width: 50px; height: 50px; object-fit: cover;"></td>
                                                ...
                                                <td>
													<a class="btn btn-info"
                                                          href="{{ route('admin.settings.edit', $setting->id) }}">تعديل</a>
