            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.sections.index') }}" class="text-muted text-hover-primary">فريق العمل-المدراء</a>
                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    action="{{ route('admin.sections.store') }}" id="create-form"
                                    ...
                                    <div class="mb-13 text-center">
                                        ...
                                        <h1 class="mb-3">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">قم بإضافة قسم جديد</font>
                                            </font>
                                        </h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
