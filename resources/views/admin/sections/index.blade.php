            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.sections.index') }}" class="text-muted text-hover-primary">الاقسام
                                المضافة</a>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.sections.create') }}" class="btn btn-sm fw-bold btn-primary">قسم جديد</a>
                    {{-- <a href="{{ route('admin.sections.trash') }}" class="btn btn-sm fw-bold btn-danger">سلة المهملات</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($sections as $section)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!$section->trashed())
                                                        <a class="btn btn-info"
                                                            href="{{ route('admin.sections.edit', $section->id) }}">تعديل</a>
                                                    @else
                                                        <form method="post"
                                                            action="{{ route('admin.sections.forceDelete', $section->id) }}">
                                                            @csrf
                                                            @method('HEAD')
                                                            <input type="submit"
                                                                class="btn btn-xs btn-danger btn-flat show_confirm"
                                                                href="{{ route('admin.sections.forceDelete', $section->id) }}"
                                                                value="حذف نهائي">
                                                        </form>
                                                    @endif
                                                ...
                                                <td>
                                                    @if ($section->trashed())
                                                        <a href="{{ route('admin.sections.restore', $section->id) }}"
