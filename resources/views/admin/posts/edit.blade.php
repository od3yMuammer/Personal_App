                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                    ...
                                    @if ($message = Session::get('success'))
                                        <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span>{{ $message }} , <a href="{{ route('admin.posts.index') }}">اضغط هنا لعرض جميع المنشورات المضاف</a></span>
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    action="{{ route('admin.posts.update', $post->id) }}" id="create-form"
