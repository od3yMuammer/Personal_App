            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.admins.index') }}" class="text-muted text-hover-primary">المدراء المضافون</a>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.admins.create') }}" class="btn btn-sm fw-bold btn-primary">مدير جديد</a>
                    {{-- <a href="{{ route('admin.admins.trash') }}" class="btn btn-sm fw-bold btn-danger">سلة المهملات</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                                ...
                                                <td>
                                                    @if (!$admin->trashed())
                                                        <a class="btn btn-info"
                                                            href="{{ route('admin.admins.edit', $admin->id) }}">تعديل</a>
                                                    @else
                                                        <form method="post"
                                                            action="{{ route('admin.admins.forceDelete', $admin->id) }}">
                                                            @csrf
                                                            @method('HEAD')
                                                            <input type="submit"
                                                                class="btn btn-xs btn-danger btn-flat show_confirm"
                                                                href="{{ route('admin.admins.forceDelete', $admin->id) }}"
                                                                value="حذف نهائي">
                                                        </form>
                                                    @endif
